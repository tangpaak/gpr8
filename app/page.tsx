    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-indigo-100 to-purple-100">
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-indigo-200">
        <Link className="flex items-center justify-center" href="#">
          <Image
            src="/6d0ee903-9b85-412f-8c25-0674d26c1ee0-removebg-preview.png"
            alt="GPR Logo"
            width={120}
            height={40}
          />
            ...
            <div className="md:w-1/2 mb-8 md:mb-0">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-indigo-200 md:text-xl">
                  Your trusted partner in gold bar trading. Secure transactions,
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
              <div className="flex flex-col items-center space-y-2 border-indigo-200 p-4 rounded-lg">
                ...
                <p className="text-sm text-indigo-600 text-center">
                  We offer the best rates in the market, ensuring you get the
              ...
              <div className="flex flex-col items-center space-y-2 border-indigo-200 p-4 rounded-lg">
                ...
                <p className="text-sm text-indigo-600 text-center">
                  Your safety is our priority. We use state-of-the-art security
              ...
              <div className="flex flex-col items-center space-y-2 border-indigo-200 p-4 rounded-lg">
                ...
                <p className="text-sm text-indigo-600 text-center">
                  With our global network, we facilitate seamless transactions
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    "Global Partner & Resources Limited has been my go-to for
                    gold trading. Their prices are unbeatable and the service is
                    top-notch."
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    "I've been recommending Global Partner & Resources Limited
                    to my clients for years. Their security measures are second
                    to none."
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    "The multi-currency support and global reach of GPR have
                    made my international gold trading seamless. Their expertise
                    is unmatched."
                  </p>
                </CardContent>
                <CardFooter>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    Learn the fundamentals of gold trading and investment.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    Stay updated with our expert analysis of the gold market.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-indigo-600">
                    Discover effective strategies for gold investment.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button
